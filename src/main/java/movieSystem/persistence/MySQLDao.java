...
public class MySQLDao {
    ...
    private String databaseName = "movie_project";
    ...
    public MySQLDao(String propertiesFilename){
        ...
        try {
            ...
            File filePath = new File("/home/developer/database.properties");
            ...
            if (!filePath.exists()) {
                ...
                properties.load(new FileInputStream("/home/developer/database.properties"));
